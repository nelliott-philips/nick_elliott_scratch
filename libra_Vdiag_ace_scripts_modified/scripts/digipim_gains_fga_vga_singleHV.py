...
def collectRawData(fileName, fgaSPIdataRegister_B4, rgcRampSPIdataRegister_64_1, rgcRampSPIdataRegister_64_2, rgcRampSPIdataRegister_64_3, rgcRampSPIdataRegister_64_4, last=False):
    if GuiTest.noneBootModeChecked():
        print('ERROR: no catheter connected')
        return
    #endif

    DiagnosticInterface.WriteToDigiPim(0x700000B4, fgaSPIdataRegister_B4)
...
def collectDataSet(suffix):
    ...
    collectRawData(suffix+'s_Prod_1_FGA0_VMAG5_VDBS0', 0x001E, 0x190000, 0x180000, 0x1B0000, 0x1A0000)
    collectRawData(suffix+'s_Prod_1_FGA5_VMAG5_VDBS0', 0x0A1E, 0x190000, 0x180000, 0x1B0000, 0x1A0000)
    collectRawData(suffix+'s_Prod_1_FGA10_VMAG5_VDBS0', 0x141E, 0x190000, 0x180000, 0x1B0000, 0x1A0000)
    collectRawData(suffix+'s_Prod_1_FGA15_VMAG5_VDBS0', 0x1E1E, 0x190000, 0x180000, 0x1B0000, 0x1A0000)
    collectRawData(suffix+'s_Prod_1_FGA20_VMAG5_VDBS0', 0x281E, 0x190000, 0x180000, 0x1B0000, 0x1A0000)
    collectRawData(suffix+'s_Prod_1_FGA25_VMAG5_VDBS0', 0x321E, 0x190000, 0x180000, 0x1B0000, 0x1A0000)
    collectRawData(suffix+'s_Prod_1_FGA30_VMAG5_VDBS0', 0x3C1E, 0x190000, 0x180000, 0x1B0000, 0x1A0000)
    collectRawData(suffix+'s_Prod_1_FGA35_VMAG5_VDBS0', 0x461E, 0x190000, 0x180000, 0x1B0000, 0x1A0000)
    collectRawData(suffix+'s_Prod_1_FGA40_VMAG5_VDBS0', 0x501E, 0x190000, 0x180000, 0x1B0000, 0x1A0000)
    collectRawData(suffix+'s_Prod_1_FGA40_VMAG5_VDBS5', 0x501E, 0x190906, 0x180906, 0x1B0906, 0x1A0906)
    collectRawData(suffix+'s_Prod_1_FGA40_VMAG5_VDBS10', 0x501E, 0x19120C, 0x18120C, 0x1B120C, 0x1A120C)
    collectRawData(suffix+'s_Prod_1_FGA40_VMAG5_VDBS15', 0x501E, 0x191B12, 0x181B12, 0x1B1B12, 0x1A1B12)
    collectRawData(suffix+'s_Prod_1_FGA40_VMAG5_VDBS20', 0x501E, 0x192418, 0x182418, 0x1B2418, 0x1A2418)
    collectRawData(suffix+'s_Prod_1_FGA40_VMAG5_VDBS25', 0x501E, 0x192D1E, 0x182D1E, 0x1B2D1E, 0x1A2D1E)
    collectRawData(suffix+'s_Prod_1_FGA40_VMAG5_VDBS30', 0x501E, 0x193624, 0x183624, 0x1B3624, 0x1A3624)
    collectRawData(suffix+'s_Prod_1_FGA40_VMAG5_VDBS35', 0x501E, 0x193F2A, 0x183F2A, 0x1B3F2A, 0x1A3F2A)
    collectRawData(suffix+'s_Prod_1_FGA40_VMAG5_VDBS40', 0x501E, 0x194830, 0x184830, 0x1B4830, 0x1A4830)
    collectRawData(suffix+'s_Prod_1_FGA40_VMAG5_VDBS45', 0x501E, 0x195136, 0x185136, 0x1B5136, 0x1A5136)
    collectRawData(suffix+'s_Prod_1_FGA40_VMAG5_VDBS50', 0x501E, 0x195A3C, 0x185A3C, 0x1B5A3C, 0x1A5A3C, True)
