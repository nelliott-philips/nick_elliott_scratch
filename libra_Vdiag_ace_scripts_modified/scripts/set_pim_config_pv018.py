...
if __name__ == 'builtins':
    ...
    str = json.dumps({
             'pimCfg': {
                 'bootMode': 'pv018', 'imageMode': 'bmode', 'rgcCal': 0,
                 'rgcBmode': {'startGain': 159, 'endGain': 194, 'slope': 0, 'gainAdj': 0, 'holdOff': 0},
                 'rgcChroma': {'startGain': 159, 'endGain': 194, 'slope': 0, 'gainAdj': 0, 'holdOff': 0},
                 'bandPassFilter': True,
                 ...
                 'txPulseBmode': {'cycleCnt': 2, 'zone0': 20, 'zone1': 25, 'zone2': 20, 'zone3': 25, 'zone4': 0,
                                  'zone5': 0},
                 'txPulseChroma': {'cycleCnt': 2, 'zone0': 25, 'zone1': 25, 'zone2': 25, 'zone3': 25, 'zone4': 0,
