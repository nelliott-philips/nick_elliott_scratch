...
if __name__ == 'builtins':
    ...
    str = json.dumps({
        'pimCfg': {'bootMode': 'pv035', 'imageMode': 'bmode', 'rgcCal': 0,
                   'rgcBmode': {'startGain': 229, 'endGain': 264, 'slope': 3, 'gainAdj': 0, 'holdOff': 0},
                   'rgcChroma': {'startGain': 59, 'endGain': 94, 'slope': 0, 'gainAdj': 0, 'holdOff': 0},
                   'bandPassFilter': True,
                   ...
                   'rfCtl': {'selfTestSel': 0, 'vmag': 3, 'atr7out': True},
                   ...
                   'sequencer': {'txStartBmode': 0, 'rxStartBmode': 0, 'txStartChroma': 0, 'rxStartChroma': 0,
                                 ...
                                 'tgcDaughtercardState': False, 'catAmpSwitchDisable': False, 'catPulseDisable': False,
                                 'catTxSwitchDisable': False}, 'pulseTiming': {
                   'txPulseBmode': {'cycleCnt': 3, 'zone0': 50, 'zone1': 50, 'zone2': 50, 'zone3': 50, 'zone4': 50,
                                    'zone5': 50},
                   'txPulseChroma': {'cycleCnt': 0, 'zone0': 0, 'zone1': 0, 'zone2': 0, 'zone3': 0, 'zone4': 0,
