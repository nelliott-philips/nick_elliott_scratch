...
def collectDataSet(suffix):
    ...
    #collectRawData(suffix+'s_Prod_1_FGA0_VMAG5_VDBS20', 0x001E, 0x190000, 0x182418, 0x1B0000, 0x1A2418)
    #collectRawData(suffix+'s_Prod_1_FGA5_VMAG5_VDBS20', 0x0A1E, 0x190000, 0x182418, 0x1B0000, 0x1A2418)
    #collectRawData(suffix+'s_Prod_1_FGA10_VMAG5_VDBS20', 0x141E, 0x190000, 0x182418, 0x1B0000, 0x1A2418)
    collectRawData(suffix+'s_Prod_1_FGA15_VMAG5_VDBS20', 0x1E1E, 0x190000, 0x182418, 0x1B0000, 0x1A2418)
    collectRawData(suffix+'s_Prod_1_FGA20_VMAG5_VDBS20', 0x281E, 0x190000, 0x182418, 0x1B0000, 0x1A2418)
    collectRawData(suffix+'s_Prod_1_FGA25_VMAG5_VDBS20', 0x321E, 0x190000, 0x182418, 0x1B0000, 0x1A2418)
    collectRawData(suffix+'s_Prod_1_FGA30_VMAG5_VDBS20', 0x3C1E, 0x190000, 0x182418, 0x1B0000, 0x1A2418)
    collectRawData(suffix+'s_Prod_1_FGA35_VMAG5_VDBS20', 0x461E, 0x190000, 0x182418, 0x1B0000, 0x1A2418)
    #collectRawData(suffix+'s_Prod_1_FGA40_VMAG5_VDBS50', 0x001E, 0x190000, 0x182418, 0x1B0000, 0x1A2418, True)
